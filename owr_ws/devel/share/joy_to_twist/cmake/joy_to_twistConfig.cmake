...
if("TRUE" STREQUAL "TRUE")
  set(joy_to_twist_SOURCE_PREFIX /home/jovanni/owr_ws/src/fake_joystick/joy_to_twist)
  set(joy_to_twist_DEVEL_PREFIX /home/jovanni/owr_ws/devel)
  ...
  set(joy_to_twist_INSTALL_PREFIX /home/jovanni/owr_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joy_to_twist' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jovanni/owr_ws/src/fake_joystick/joy_to_twist/${idir}'.  ${_report}")
    endif()
